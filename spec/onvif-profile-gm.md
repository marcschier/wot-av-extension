...
The [G/M ledger](../bindings/onvif/catalog/requirements-gm.json) records **634
...
[editorial decisions](../bindings/onvif/catalog/editorial-decisions.json) are
...
[vectors](../bindings/onvif/examples/requirements-gm-vectors.json) contain
