...
[generated reference](terms.md) describes every active entry. Earlier
...
The [v0.1 archive](../archive/v0.1-proposed/spec.md) belongs under
`archive/v0.1-proposed/`. Its source is the **committed pre-migration HEAD**,
