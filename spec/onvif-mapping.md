...
[`sources.lock.json`](../bindings/onvif/sources.lock.json) remains the only
...
The generated [payload library](../bindings/onvif/schemas/payloads.schema.json)
...
schemas and [coverage](../bindings/onvif/coverage/coverage.json) agree on
...
See [support versus conformance](onvif-conformance.md).
...
`packages\binding-onvif\src\catalog\snapshot.ts`; the projector is
...
Use the [fully typed integration helper](../bindings/onvif/readme.md#typed-integration-helper)
