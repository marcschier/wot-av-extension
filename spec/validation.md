...
[per-entry reference](terms.md), and the [native ONVIF boundary](onvif-integration.md).
...
is a separate setup step; the [README](../readme.md#local-setup-and-checks)
...
The [vendored provenance manifest](../third_party/wot/manifest.json) identifies
...
The authored [term inventory](../vocabulary/terms.json) owns the definitions
and explanatory metadata. The generated [reference](terms.md) gives a
...
The [v0.1 archive](../archive/v0.1-proposed/spec.md), separate
...
[^pinned-schema]: W3C TD repository at `87808f1644ba79eb0a58d238385a8bd4a2236853`,
    ...
    exact local copy and recorded limitations in [the provenance manifest](../third_party/wot/manifest.json).
