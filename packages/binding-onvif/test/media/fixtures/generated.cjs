...
const { compileCatalog } = require("../.compiled/catalog/compiler.js");
const { loadRequirementIndex } = require("../.compiled/catalog/requirements.js");
const { defineOperationRegistry } = require("../.compiled/binding/registry.js");
const { project } = require("../.compiled/projection/project.js");
