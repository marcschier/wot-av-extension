...
const { generatedThing, soapFixture } = require("./fixtures/generated.cjs");
const { nativeEnvironment, startFixture, collect, collectAll, waitFor } = require("./fixtures/native.cjs");
