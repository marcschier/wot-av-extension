...
[native Form gate](../../samples/reference-runtime/src/binding/forms.ts).
...
Use the local [context](../../context.jsonld) or a
...
The [schema generator](../../samples/reference-runtime/src/catalog/schemas.ts) derives
...
The [projector](../../samples/reference-runtime/src/projection/project.ts#L511-L608)
...
[`canonicalDataSchema`](../../samples/reference-runtime/src/binding/forms.ts#L88-L93):
