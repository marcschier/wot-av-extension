...
[`requirements-st.json`](../../requirements/requirements-st.json) maps
...
[editorial register](../editorial/editorial-decisions.json) remain
...
[`requirements-st-vectors.json`](../../tools/fixtures/requirements/requirements-st-vectors.json)
