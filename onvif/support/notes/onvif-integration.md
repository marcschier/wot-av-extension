...
implements a [native WoT client binding](../reference-runtime-guide.md), while
the [AV `0.2-proposed` specification](../../../av/spec.md) remains a separate, thin,
...
or profile certificate. See the [support matrix](../reports/onvif-conformance.md) for
...
the [typed quickstart](../reference-runtime-guide.md#typed-integration-helper) and
...
<!-- example: onvif/examples/onvif-adapter.json# -->
```json
{
...
[runtime/media evidence](../reports/onvif-conformance.md); reverse replay is not implemented.
...
concerns. A passing [offline check](../../../av/support/validation.md) proves none of those.
