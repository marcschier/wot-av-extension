...
The [A/C/D ledger](../../requirements/requirements-acd.json) contains
...
to operate a device. The [offline vectors](../../tools/fixtures/requirements/requirements-acd-vectors.json)
...
The [source lock](../../sources.lock.json) is the authority for
...
[editorial IDs](../editorial/editorial-decisions.json) are
...
[source groups](../../sources.lock.json)
