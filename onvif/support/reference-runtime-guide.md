...
The optional [AV 0.2 metadata specification](../../av/spec.md) is complementary,
...
| --- | --- |
| [Native integration](notes/onvif-integration.md) | Seven-profile scope, native operation flow, ownership, and why WoT remains optional. |
| [Source catalog](notes/onvif-sources.md), [source lock](../sources.lock.json), [profile editions](../profile-editions.json) | Exact release 26.06 commit, service/schema versions, seven PDF pins, exclusions and redistribution decisions. |
| [S/T ledger](notes/onvif-profile-st.md), [G/M ledger](notes/onvif-profile-gm.md), [A/C/D ledger](notes/onvif-profile-acd.md) | 2,636 device/client requirement atoms, source locators, conditions, alternatives, and remaining process/editorial gates. |
| [Compiler and projection](notes/onvif-mapping.md), [coverage](reports/coverage.json) | 579 compiled operation graphs, 3,426 type contracts, reusable models and evidence-preserving observed TDs. |
| [Binding reference](notes/onvif-binding-reference.md), [inventory](../terms.json) | Every current vocabulary entry, authorship/use/defaults, native Form rules, and private runtime-field boundaries. |
| [Native SOAP binding](notes/onvif-binding.md), [Events](notes/onvif-events.md) | Actual node-wot Action/Event execution, canonical XML, scoped credentials, faults and awaited lifecycle. |
| [Node media](notes/onvif-node-media.md), [native media](notes/onvif-media.md), [native qualification](reports/onvif-media-qualification.md) | URI resolution, per-open RTSP sessions, decoded units/metadata/backchannel and the measured codec/transport matrix. |
| [Discovery](notes/onvif-discovery.md), [composed runtime/CLI](notes/onvif-runtime.md) | Read-only inspection, model hosting, Directory/file publication, identities, leases and explicit logical-EPR authorization. |
| [Support and conformance boundaries](reports/onvif-conformance.md) | Declared/mapped versus exercised, conditional, unsupported and unqualified behavior. |
| [Packaging](notes/onvif-packaging.md) | Current install/build/CI commands, native prerequisites, package provenance and promotion gates. |

The [first SOAP gate report](reports/onvif-runtime-qualification.md) is a
dated, narrower qualification record, not the current script/API inventory.
The [generated manifest](../model-manifest.json) owns 304 listed artifacts
...
[native execution](notes/onvif-runtime.md#scope-and-qualification) is
...
[public exports](../samples/reference-runtime/src/index.ts).
...
The [media resolver](../samples/reference-runtime/src/media/executor.ts)
...
[`native.trust.authorizeLogicalEndpoint`](notes/onvif-runtime.md#logical-epr-authorization-status)
