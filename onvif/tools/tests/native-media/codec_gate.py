...
Example (from the repository root):
  python -B onvif\\tools\\tests\\native-media\\codec_gate.py --worker WORKER.exe
      --sdk-root SDK --case all --report onvif\\samples\\reference-runtime\\native-media\\build-p0\\codec-generated\\report.json
