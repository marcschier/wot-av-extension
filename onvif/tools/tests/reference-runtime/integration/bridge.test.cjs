...
} = require("../../../../samples/reference-runtime/dist/index.js");
const { nativeFixture, NS, EDITIONS, DSA } = require("../../../fixtures/reference-runtime/integration/native.cjs");
const { directory } = require("../../../fixtures/reference-runtime/publication/directory.cjs");
