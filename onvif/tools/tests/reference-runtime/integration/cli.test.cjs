...
const { loadBridgeConfiguration } = require("../../../../samples/reference-runtime/dist/cli/config.js");
const { createOnvifRuntime, loadPackagedCatalog, defineOperationRegistry, RuntimeReadAdapter,
    operationKey, readEndpointReference, parseXml } = require("../../../../samples/reference-runtime/dist/index.js");
const wire = require("../../../fixtures/reference-runtime/endpoint.cjs");
const { nativeFixture, NS, DSA, WSA } = require("../../../fixtures/reference-runtime/integration/native.cjs");

const cli = path.resolve(__dirname, "../../../../samples/reference-runtime/dist/cli/main.js");
