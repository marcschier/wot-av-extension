...
const { defineOperationRegistry, createOnvifRuntime } = require("../../../../samples/reference-runtime/dist");
const { device, collision, reference, operations, td } = require("../../../fixtures/reference-runtime/operations.cjs");
