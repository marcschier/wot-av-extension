...
const { parseXml, serializeXml, decodeElement, encodeElement } = require("../../../../samples/reference-runtime/dist");
const { mappingElement, q, scalar, element, field } = require("../../../fixtures/reference-runtime/operations.cjs");
const { mapping, infoset, parseWire } = require("../../../fixtures/reference-runtime/endpoint.cjs");
