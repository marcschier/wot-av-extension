...
const wire = require("../endpoint.cjs");
const { compileCatalog } = require("../../../tests/reference-runtime/events/.compiled/catalog/compiler");
const { actionTemplate, eventTemplate, context } = require("../../../tests/reference-runtime/events/.compiled/catalog/models");
const { defineOperationRegistry } = require("../../../tests/reference-runtime/events/.compiled/binding/registry");
const { createOnvifRuntime } = require("../../../tests/reference-runtime/events/.compiled/binding/runtime");
