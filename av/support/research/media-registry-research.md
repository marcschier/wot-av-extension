...
not requirements of the active core. See the [migration note](../migration.md)
and [ONVIF reuse boundary](../../../onvif/support/notes/onvif-integration.md).
...
[authored term inventory](../../terms.json) remain **normative for this
...
The [v0.1 matching rules](../history/v0.1-proposed/spec.md#6-needs-feasibility-and-acceptance) made
...
[v0.1 lifecycle specification](../history/v0.1-proposed/spec.md#9-immutable-lifecycle-and-external-authority),
...
see its [historical fixture notes](../history/v0.1-proposed/examples/NOTES.md).
