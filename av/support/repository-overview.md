...
| [Native ONVIF WoT binding](../../onvif/support/reference-runtime-guide.md) | Canonical models and separate device/client requirement mappings for **all seven released profiles A/C/D/G/M/S/T**, native SOAP/Events through node-wot, native C/GStreamer RTSP sessions, and a read-only discovery-to-Directory/file publisher with CLI. |
...
media evidence is described in the [support matrix](../../onvif/support/reports/onvif-conformance.md).
The bounded bridge/Directory consumer path now passes with
[explicit logical-EPR authorization](../../onvif/support/notes/onvif-runtime.md#logical-epr-authorization-status),
...
Read [native ONVIF integration](../../onvif/support/notes/onvif-integration.md) for the protocol and
ownership boundaries. For the implemented binding, use its
[specification index and typed quickstart](../../onvif/support/reference-runtime-guide.md) and
[bridge configuration](../../onvif/support/notes/onvif-runtime.md). For optional AV descriptions,
start with the
...
| Location | Purpose |
| --- | --- |
| [av/spec.md](../spec.md) | Native-first decision, six explained diagrams, complete fragments, and matching/default rules. |
| [onvif/support/reference-runtime-guide.md](../../onvif/support/reference-runtime-guide.md) | Native binding specification index, actual package exports, and a typed integration helper. |
| [onvif/support/notes/onvif-integration.md](../../onvif/support/notes/onvif-integration.md) | Seven-profile native scope, real operation flow, optional AV ownership, and primary ONVIF citations. |
| [onvif/support/notes/onvif-sources.md](../../onvif/support/notes/onvif-sources.md), [profile editions](../../onvif/profile-editions.json) | Complete locked source catalog, exact release/edition pins, exclusions, and rights gates. |
| [S/T ledger](../../onvif/support/notes/onvif-profile-st.md), [G/M ledger](../../onvif/support/notes/onvif-profile-gm.md), [A/C/D ledger](../../onvif/support/notes/onvif-profile-acd.md) | 2,636 role-specific requirement atoms, native locators, conditions, alternatives, and unresolved obligations. |
| [onvif/support/notes/onvif-mapping.md](../../onvif/support/notes/onvif-mapping.md), [binding reference](../../onvif/support/notes/onvif-binding-reference.md) | Canonical compiler, generated models, XML/JSON rules, and every current binding vocabulary entry. |
| [native SOAP](../../onvif/support/notes/onvif-binding.md), [Events](../../onvif/support/notes/onvif-events.md), [Node media](../../onvif/support/notes/onvif-node-media.md) | Direct node-wot execution and separately owned native RTSP media sessions. |
| [bridge/CLI](../../onvif/support/notes/onvif-runtime.md), [support matrix](../../onvif/support/reports/onvif-conformance.md), [packaging](../../onvif/support/notes/onvif-packaging.md) | Discovery/publication, measured scope versus deferred behavior, and installation/build/publication gates. |
| [av/support/reference/terms.md](reference/terms.md) | Generated per-entry reference and TOC: who authors it, what it describes, how it is used, and omission/default behavior. |
| [av/terms.json](../terms.json) | Authored term inventory and documentation metadata. |
| [av/context.jsonld](../context.jsonld), [av/ontology.ttl](../ontology.ttl) | Generated JSON-LD context and vocabulary. |
| [av/av.shacl.ttl](../av.shacl.ttl), [av/support/validation.md](validation.md) | Structural constraints and the distinct JSON, TD, RDF, metadata-schema, and implementation boundaries. |
| [av/examples/source.td.json](../examples/source.td.json), [av/examples/live.td.json](../examples/live.td.json), [av/examples/clip.td.json](../examples/clip.td.json) | Still, joint live audio/video, and whole finite Clip descriptions. |
| [av/examples/processor.td.json](../examples/processor.td.json), [av/examples/result-need.jsonld](../examples/result-need.jsonld) | Explicit processor interfaces, native result schema, and optional destination selection. |
| [av/examples/sink.td.json](../examples/sink.td.json) | Receiver-owned native input schema and Form; no implicit push or durability. |
| [av/examples/live-need.jsonld](../examples/live-need.jsonld), [av/examples/two-input-need.jsonld](../examples/two-input-need.jsonld) | Complete live-track requirements and separately named application inputs, without a scheduler. |
| [onvif/examples/onvif-adapter.json](../../onvif/examples/onvif-adapter.json), [av/examples/NOTES.md](../examples/NOTES.md) | Synthetic read-only adapter configuration and exact example scope. |
| [av/tools/generate.py](../tools/generate.py), [av/tools/check_docs.py](../tools/check_docs.py), [av/tools/validate.py](../tools/validate.py) | Intentional generation, documentation checks, and offline validation. |
| [av/support/migration.md](migration.md) | Breaking IRI/behavior changes and deprecated v0.1 archive boundary. |
| [av/support/research/media-registry-research.md](research/media-registry-research.md) | Main research report: public-standards-based, informative rationale, transport findings, and tradeoffs. |
| [av/support/publication/provenance.json](publication/provenance.json), [av/support/publication/release-manifest.json](publication/release-manifest.json) | Publication provenance and explicitly scoped integrity inventory. |
...
See [packaging](../../onvif/support/notes/onvif-packaging.md) and
[explicit media prerequisites](../../onvif/support/notes/onvif-runtime.md#scope-and-qualification).
...
[source authority](../../onvif/support/notes/onvif-sources.md), [generated inventory](../../onvif/model-manifest.json),
and [publication boundaries](../../onvif/support/notes/onvif-packaging.md). Its package/context
version `0.1` is unrelated to the deprecated AV v0.1 design.
The [v0.1 specification](history/v0.1-proposed/spec.md) is **deprecated
...
[upstream notice](upstream/wot/LICENSE.md),
[full license](upstream/wot/LICENSE-W3C-2023.txt), and
[redistribution notice](upstream/wot/NOTICE-W3C.txt).
Their [provenance manifest](upstream/wot/manifest.json) records source
...
[^onvif]: The [locked seven-profile catalog](../../onvif/profile-editions.json)
